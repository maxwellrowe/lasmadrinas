...
class GF_NMI_License_Updates {

	const SECRET_KEY = '5b2e2491cc5129.56732842';
	const SERVER_URL = 'https://wpgateways.com';
	const LONG_NAME = 'Gravity Forms Network Merchants (NMI) Gateway (Basic)';
	const SHORT_NAME = 'Gravity Forms Network Merchants (NMI)';
	const VAR_IDS = '3954,3955,3956,17952,29944,29948,29952,29956';
	const PLUGIN_SLUG = 'gravityforms-nmi-gateway';
	...
	public static function get_instance() {
		if ( self::$_instance == null ) {
			self::$_instance = new GF_NMI_License_Updates();
		}
	...
	public static function call_service_api( $api_params ) {
        ...
        $response = wp_remote_get( $query, array( 'timeout' => 20, 'sslverify' => false, 'headers' => array( 'Content-Type'  => 'application/json', 'Accept'  => 'application/json' ) ) );
...
GF_NMI_License_Updates::get_instance();