		...
		<div class="user-pass1-wrap">
			...
			<div class="wp-pwd">
				<div class="password-input-wrapper">
					<input type="password" data-pw="<?php echo esc_attr( wp_generate_password( 16 ) ); ?>" name="pass1" id="pass1" class="input password-input" value="" autocomplete="off" aria-describedby="pass-strength-result" />
