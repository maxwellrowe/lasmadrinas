<div class="fancy-list calendar-and-events-component">
	...
	<div class="fancy-list-top row">
		...
		<div class="small-12 medium-8 large-9 columns">
			...
			<?php the_field('calendar_and_event_title','option'); ?>
			
		<!--/medium-8--></div>
		
		<div class="small-12 medium-4 large-3 columns">
			
			<?php if(get_field('upload_calendar_pdf','option')) { ?>
			
				<a href="<?php the_field('upload_calendar_pdf','option'); ?>"><?php the_field('calendar_pdf_link_text','option'); ?></a>
